...
export default function Register() {
  ...
  const { register, googleLoginUrl, githubLoginUrl } = useAuth();
        ...
        <div className="glass-panel rounded-3xl p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input type="checkbox" id="terms" required className="w-4 h-4 mt-0.5 rounded border-white/20 bg-zinc-900/50 text-blue-600 focus:ring-blue-500/20 focus:ring-offset-0" />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold py-4 rounded-xl hover:from-blue-500 hover:to-cyan-400 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_30px_rgba(37,99,235,0.3)]"
            >
              {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <a href={googleLoginUrl} className="flex items-center justify-center gap-2 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-zinc-300 hover:bg-white/[0.06] hover:border-white/20 transition-all text-sm font-medium">
            ...
            <a href={githubLoginUrl} className="flex items-center justify-center gap-2 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-zinc-300 hover:bg-white/[0.06] hover:border-white/20 transition-all text-sm font-medium">
